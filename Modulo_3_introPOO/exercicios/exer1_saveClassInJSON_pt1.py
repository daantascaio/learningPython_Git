...
PATH_FILE = 'C:\\Users\\elenice Ferreira\\Desktop\\learningPython_Git\\Modulo_3_introPOO\\exercicios\\exer1_people_one.json'
...
#-- # -- #
with open(PATH_FILE, 'w', encoding='utf8') as json.file:
    json.dump(
        data_people_one,
        json.file,
        indent=2,
...
# -- # -- #
# with open('Modulo_3_introPOO\\exercicios\\exer1_people_one.json', 'r', encoding='utf8') as json.file:
